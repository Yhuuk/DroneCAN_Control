...
#define Confrim_Pin GPIO_PIN_14
#define Confrim_GPIO_Port GPIOB
...
#define Throttle_LED_Pin GPIO_PIN_3
#define Throttle_LED_GPIO_Port GPIOB
#define Direction_LED_Pin GPIO_PIN_4
#define Direction_LED_GPIO_Port GPIOB
#define CAN_LED_Pin GPIO_PIN_8
